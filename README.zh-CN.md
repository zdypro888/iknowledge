...
| 维 | `kb_status` | 库健康:覆盖率/suspect/孤儿/欠账/热点,以及纯本地 semantic 健康与精确 next_action |
| 维 | `kb_semantic` | 纯本地 status,或按用户持久授权执行一次 sync;绝不配置、安装、下载或切换模型 |
